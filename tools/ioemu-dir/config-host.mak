...
# Configured with: '/usr/src/xen_build_from_xen_source/xen-4.1.2/tools/../tools/ioemu-qemu-xen/configure' '--disable-gfx-check' '--disable-curses' '--disable-slirp' '--prefix=/usr'
prefix=/usr
bindir=${prefix}/bin
...
CONFIG_OSS_LIB=
VERSION=0.10.2
SRC_PATH=/usr/src/xen_build_from_xen_source/xen-4.1.2/tools/ioemu-qemu-xen
VPATH=/usr/src/xen_build_from_xen_source/xen-4.1.2/tools/ioemu-qemu-xen
...
XEN_ROOT=/usr/src/xen_build_from_xen_source/xen-4.1.2/tools/..
QEMU_ROOT ?= .
